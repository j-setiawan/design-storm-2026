...
Mile, Cheesman, Dillon inflow/outflow, from teams/model-comparison/
reservoir_ops_history.json), lagged 14 days -- a real, tested improvement
(R2 0.61 -> 0.69) over the sentinel-gage-only model. See
teams/model-comparison/test_upstream_reservoir_features.py for the comparison.
...
DATA = "data"
RESERVOIR_OPS = "teams/model-comparison/reservoir_ops_history.json"
